                        ...
                        <div class="bg-dark rounded p-4 p-sm-5 my-4 mx-3">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <a href="#" class="">
                                    ...
                                    <h3 class="text-white"><i class="fa fa-user-edit me-2"></i>Add category</h3>
                                </a>
                            </div>
                            ...
                            <form action="code/add-category.php" method="post" enctype="multipart/form-data" data-parsley-validate="">
                                <div class="form-group mb-3 mt-3">
                                    <label for="exampleInputEmail1" class="mb-2">Name:</label>
                                    <input type="text" class="form-control for-c1 " style="height: 50px; background:beige;" id="c1s" aria-describedby="emailHelp" name="name" placeholder="Enter category name" >
                                    <p style="color: red;">
                                        <?php
                                ...
                                <button type="submit" class="btn btn-white py-3 w-100 mb-4 text-dark">Add Category</button>
                            </form>
